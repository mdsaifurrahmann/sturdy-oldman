                ...
                <div class="col-span-3">
                    ...
                    <div class="swiper main__slider h-[500px] rounded-lg">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset(mix('images/slider/01.jpg')) }}" alt="slider-1"
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset(mix('images/slider/02.jpg')) }}" alt="slider-1"
                                    class="object-cover w-full h-[inherit]">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset(mix('images/slider/03.jpg')) }}" alt="slider-1"
                                    class="object-cover w-full h-[inherit]">
                                ...
                                <div class="apa-items">
                                    <ul class="flex flex-col gap-1 arrow">
                                        ...
                                        <li class="apa-item"><a href="#">ত্রৈমাসিক/বার্ষিক পরিবীক্ষণ/মূল্যায়ন
                                                প্রতিবেদন</a></li>
                                        <li class="apa-item"><a
                                                href="#">আইন/বিধি/নীতিমালা/পরিপত্র/নির্দেশিকা/প্রজ্ঞাপন</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="machinery card">
                        ...
                        <div>
                            ...
                            <ul
                                class="grid grid-cols-1 xs:grid-cols-2 xm:grid-cols-4 gap-3 list-decimal list-inside arrow text-gray-600">
                    ...
                    <div class="message card">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-4 gap-6 justify-center items-center">
                            <div class="sm:col-span-1 flex justify-center">
                                <img src="{{ asset(mix('images/avatars/8.png')) }}" alt="Principle Says"
                                    class="rounded-full">
                            </div>
