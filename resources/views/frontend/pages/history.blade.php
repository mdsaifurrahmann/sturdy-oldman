...
@section('main-content')
    ...
    <div class="card text-center text-gray-800">
        ...
        <div class="mt-4">
            <img
                src="{{ Illuminate\Support\Facades\File::exists('images/institute/' . $history->image) ?  "data:image/png;base64,". base64_encode(file_get_contents(public_path('images/institute/' . $history->image))) : ""}}"
