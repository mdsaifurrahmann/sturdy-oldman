                        ...
                        <span class="brand-logo">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <defs>
                                    ...
                                    <linearGradient id="New_Gradient_Swatch_1" x1="29.41" y1="11.1"
                                        x2="36.44" y2="15.15" xlink:href="#linear-gradient" />
    ...
    <div class="bookmark-wrapper d-flex align-items-center">
        ...
        <ul class="nav navbar-nav">
            <li class="nav-item d-none d-lg-block">
                ...
                <!-- welcome -->
                Welcome back, {{ strtoupper(Auth::user()->name) }}! <span style="font-size: 24px">👋</span>
    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <span class="avatar">
                    <img class="round"
                        src="{{ Auth::user()->profile->profile_image ? asset('images/profile/' . Auth::user()->profile->profile_image) : asset(mix('images/portrait/small/avatar-s-11.jpg')) }}"
